...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\up.png").resize((13, 13)))
        right = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\right.png").resize((13, 13)))
        left = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\left.png").resize((13, 13)))
        down = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\circle.png").resize((65, 65)))
